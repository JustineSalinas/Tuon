          ...
          >
            <div className="flex h-12 w-full items-end justify-center">
              <div
                ...
                style={{
                  height:
                    value === 0 ? 2 : `${Math.max(7, (value / scale) * 62)}px`,
                }}
              />
            </div>
            <span
...
function Sidebar() {
  ...
  return (
    <div className="bg-sidebar border-border hidden w-64 shrink-0 flex-col border-r p-4 lg:flex">
      ...
      <span className="bg-primary text-primary-foreground mt-4 flex items-center justify-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium">
  ...
  return (
    <div className="border-border bg-background overflow-hidden rounded-2xl border shadow-[0_24px_70px_-30px_rgba(0,0,0,0.35)]">
      ...
      <div className="border-border bg-secondary/60 flex items-center gap-2 border-b px-4 py-2.5">
        ...
        <span className="text-muted-foreground mx-auto text-[13px]">
          tuon.app
        </span>
      </div>

      <div className="flex min-h-[27rem] md:min-h-[33rem]">
        <Sidebar />
                ...
                {done ? (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="mt-1.5 block text-[15px] leading-snug font-medium">
                        {card.front}
                      </span>
                      ...
                      {revealed ? (
                        <motion.span
                          ...
                          className="border-border mt-2.5 block border-t pt-2.5 text-[15px] leading-relaxed"
                        >
                          {card.back}
                        </motion.span>
                      ) : (
                        <span className="text-muted-foreground mt-2.5 block text-sm">
