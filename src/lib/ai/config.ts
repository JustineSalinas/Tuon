...
export const PLANS: Record<Plan, PlanDefinition> = {
  free: {
    ...
    features: [
      ...
      "Unlimited notes and PDF imports",
      "Unlimited flashcards you write yourself",
      "Full spaced repetition and quizzes",
      "Linked notes, graph, and review calendar",
    ],
    plannedFeatures: [],
    highlighted: false,
  },
